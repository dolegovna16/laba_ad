...
methods = ["bilinear", "cubic", "lanczos"]
...
for tile in tiles:
    ...
    for method in methods:
        try:
            ...
            with rasterio.open(
                    f"C:/Users/User/Desktop/Homework/2year/2/AD/lab7_1/output2/concatenated_RGB_image_{tile}.tif") as src:
                original = src.read()  # 3 bands

            # pan-sharpened file
            with rasterio.open(
                    f"C:/Users/User/Desktop/Homework/2year/2/AD/lab7_1/output2/pansharpened_{method}_{tile}.tif") as src:
                sharpened = src.read()
